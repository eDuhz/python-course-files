...
"""change the directory so it don't bug when you run this file"""
for zone in os.listdir('/Coding/Python - Course'):
...
closeButton = tkinter.Button(mainWindow, text= 'Close', command= mainWindow.destroy)
okButton.grid(row= 4, column= 3, sticky='e')
closeButton.grid(row= 4, column= 4, sticky='w')
